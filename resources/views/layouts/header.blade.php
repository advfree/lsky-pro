<header class="transition-all duration-300 w-full h-14 bg-gray-700 dark:bg-gray-800 text-white flex justify-center fixed top-0 z-[9] shadow-[0_15px_10px_-15px_rgba(0,0,0,0.3)]">
